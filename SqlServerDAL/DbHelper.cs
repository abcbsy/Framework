...
namespace SqlServerDAL
{
    ...
    public class DbHelper
    {
        ...
        /// 分页方法
        /// </summary>
        /// <param name="PageSize">当前页显示量</param>
        ...
        /// <summary>
        /// 分页获取数据，需要P_Page(@sqlstr, @curpage, @pagesize)存储过程
        /// </summary>
        /// <param name="strSQL">SQL语句</param>
        /// <param name="curPage">当前页码</param>
        /// <param name="pageSize">每页显示行数</param>
        /// <returns>返回三个Table：Table[0]为空表，Table[1](Tatol, PageCount, CurPage)，Table[2]为查询结果表</returns>
